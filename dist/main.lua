...
__lua("roblox-ts-model", "ModuleScript", "roblox-ts-model", nil, function()
	local _=__env("roblox-ts-model")local script,require=_.script,_.require -- Compiled with roblox-ts v2.3.0
...
__lua("General", "ModuleScript", "roblox-ts-model.General", "roblox-ts-model", function()
	local _=__env("roblox-ts-model.General")local script,require=_.script,_.require -- Compiled with roblox-ts v2.3.0
...
local function GetPassKey()
	local ReqPasskey = Remote:WaitForChild("ReqPasskey")
...
__lua("fetchButtons", "ModuleScript", "roblox-ts-model.Map.fetchButtons", "roblox-ts-model.Map", function()
	local _=__env("roblox-ts-model.Map.fetchButtons")local script,require=_.script,_.require -- Compiled with roblox-ts v2.3.0
local function default(map)
	local Buttons = {}
	for k, v in pairs(map:GetDescendants()) do
		if v:IsA("ImageLabel") and v.Name == "ButtonIcon" then
			local BillboardGui = v.Parent
			if BillboardGui ~= nil then
				local ButtonModel = BillboardGui.Parent
				if ButtonModel ~= nil and ButtonModel:IsA("Model") then
					Buttons[ButtonModel] = true
				end
			end
		end
	end
...
__lua("fetchCurrentButton", "ModuleScript", "roblox-ts-model.Map.fetchCurrentButton", "roblox-ts-model.Map", function()
	local _=__env("roblox-ts-model.Map.fetchCurrentButton")local script,require=_.script,_.require -- Compiled with roblox-ts v2.3.0
local function default(map)
	for k, v in pairs(map:GetDescendants()) do
		if v:IsA("ImageLabel") and v.Name == "ButtonIcon" then
			local Green = Color3.new(0, 1, 0)
			local Blue = Color3.new(0, 1, 1)
			if v.ImageColor3 == Green or v.ImageColor3 == Blue then
				local BillboardGui = v.Parent
				if BillboardGui ~= nil then
					local ButtonModel = BillboardGui.Parent
					if ButtonModel ~= nil and ButtonModel:IsA("Model") then
...
__lua("fetchSpawn", "ModuleScript", "roblox-ts-model.Map.fetchSpawn", "roblox-ts-model.Map", function()
	local _=__env("roblox-ts-model.Map.fetchSpawn")local script,require=_.script,_.require -- Compiled with roblox-ts v2.3.0
local function default(map)
	local Spawn
	for k, v in pairs(map:GetChildren()) do
		if v:IsA("Part") then
			local YSize = math.floor(v.Size.Y * 10) / 10
			if YSize ~= 0.1 then
				continue
			end
...
__lua("UI", "ModuleScript", "roblox-ts-model.UI", "roblox-ts-model", function()
	local _=__env("roblox-ts-model.UI")local script,require=_.script,_.require -- Compiled with roblox-ts v2.3.0
local TS = require(script.Parent.include.RuntimeLib)
...
if _result ~= nil then
	_result = _result:WaitForChild("CL_MAIN_GameScript")
end
...
__lua("Promise", "ModuleScript", "roblox-ts-model.include.Promise", "roblox-ts-model.include", function()
	local _=__env("roblox-ts-model.include.Promise")local script,require=_.script,_.require --[[
...
__lua("RuntimeLib", "ModuleScript", "roblox-ts-model.include.RuntimeLib", "roblox-ts-model.include", function()
	local _=__env("roblox-ts-model.include.RuntimeLib")local script,require=_.script,_.require local Promise = require(script.Parent.Promise)
...
__lua("services", "ModuleScript", "roblox-ts-model.include.node_modules.@rbxts.services", "roblox-ts-model.include.node_modules.@rbxts", function()
	local _=__env("roblox-ts-model.include.node_modules.@rbxts.services")local script,require=_.script,_.require return setmetatable({}, {
